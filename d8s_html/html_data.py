...
def html_text(html_content: StringOrBeautifulSoupObject) -> str:
    ...
    text = " ".join(html_content.findAll(text=True))  # type: ignore[union-attr,call-arg]  # decorator soupifies html_content
    return text


@stringify_first_arg
def html_unescape(html_content: StringOrBeautifulSoupObject) -> str:
    return html.unescape(html_content)  # type: ignore[type-var,return-value]  # decorator stringifies html_content


@stringify_first_arg
def html_escape(html_content: StringOrBeautifulSoupObject) -> str:
    return html.escape(html_content)  # type: ignore[type-var,return-value]  # decorator stringifies html_content
...
def html_to_markdown(html_content: StringOrBeautifulSoupObject, **kwargs) -> str:
    ...
    return markdown_creator.handle(html_content)  # type: ignore[arg-type]  # decorator stringifies html_content
...
def html_find_comments(html_content: StringOrBeautifulSoupObject) -> str:
    ...
    return html_content.find_all(string=lambda text: isinstance(text, bs4.Comment))  # type: ignore[union-attr,return-value]  # decorator soupifies html_content
...
def html_remove_tags(html_content: StringOrBeautifulSoupObject) -> bs4.BeautifulSoup:
    text = " ".join(html_content.findAll(text=True))  # type: ignore[union-attr,call-arg]  # decorator soupifies html_content
    return text  # type: ignore[return-value]  # function historically returns the extracted text
...
def html_remove_element(html_content: StringOrBeautifulSoupObject, element_tag: str) -> bs4.BeautifulSoup:
    """."""
    [s.extract() for s in html_content(element_tag)]  # type: ignore[operator]  # decorator soupifies html_content
    return html_content  # type: ignore[return-value]  # decorator soupifies html_content
...
def html_find_css_path(html_content: StringOrBeautifulSoupObject, css_path: str) -> ListOfBeautifulSoupTags:
    ...
    elements = html_content.select(css_path)  # type: ignore[union-attr]  # decorator soupifies html_content
    return elements
...
def html_elements_with_class(
    ...
    return html_content.findAll(attrs={"class": html_element_class})  # type: ignore[union-attr,call-arg]  # decorator soupifies html_content
...
def html_elements_with_id(html_content: StringOrBeautifulSoupObject, html_element_id: str) -> ListOfBeautifulSoupTags:
    ...
    return html_content.findAll(attrs={"id": html_element_id})  # type: ignore[union-attr,call-arg]  # decorator soupifies html_content
...
def html_elements_with_tag(html_content: StringOrBeautifulSoupObject, tag: str) -> ListOfBeautifulSoupTags:
    """."""
    return html_content.findAll(tag)  # type: ignore[union-attr,call-arg]  # decorator soupifies html_content; findAll accepts a tuple of tags
...
def html_headings_table_of_contents(html_content: StringOrBeautifulSoupObject) -> ListOfBeautifulSoupTags:
    ...
    return data  # type: ignore[return-value]  # returns Heading namedtuples consumed by _html_headings_toc
...
def _html_headings_toc(heading_named_tuples: ListOfBeautifulSoupTags, indentation: str, level: int = 0) -> str:
    ...
    for i in heading_named_tuples:
        s += f"{indentation * level}{i.heading.text}\n"  # type: ignore[union-attr]  # i is a Heading namedtuple
        s += _html_headings_toc(i.children, indentation, level + 1)  # type: ignore[arg-type]  # i is a Heading namedtuple
...
def html_headings(html_content: StringOrBeautifulSoupObject) -> ListOfBeautifulSoupTags:
    ...
    headings = html_elements_with_tag(html_content, heading_tags)  # type: ignore[arg-type]  # findAll accepts a tuple of tags
...
def html_to_json(html_content: StringOrBeautifulSoupObject, *, convert_only_tables: bool = False):
    ...
    if convert_only_tables:
        return html_to_json.convert_tables(html_content)  # type: ignore[arg-type]  # decorator stringifies html_content
    else:
        return html_to_json.convert(html_content)  # type: ignore[arg-type]  # decorator stringifies html_content
